<template>
    <div style="height: 100%; overflow: auto">
        <v-card-text>
            <v-row>
                <v-col>
                    <v-text-field label="이름" v-model="user.name" :disabled="readonly" clearable></v-text-field>
                </v-col>
                <v-col>
                    <v-text-field label="성별" v-model="user.sex" :disabled="readonly" clearable></v-text-field>
                </v-col>
            </v-row>
